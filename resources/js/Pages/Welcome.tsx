...
function Reveal({
    ...
    return (
        <div
            ...
            className={cn(
                'transition-all will-change-transform [transition-duration:900ms] [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] motion-reduce:transition-none',
                visible
...
function SectionHeading({ kicker, title }: { kicker: string; title: string }) {
    return (
        <div className="mb-12">
            <div className="mb-3 font-mono text-xs uppercase tracking-[0.3em] text-muted-foreground">
                {kicker}
            </div>
    ...
    return (
        <div className="relative isolate min-h-screen bg-background text-foreground">
            ...
            <div
                ...
                className="fixed inset-x-0 top-0 z-[60] h-0.5 origin-left bg-foreground/80 will-change-transform"
            />

            <AmbientBackground progress={progress} />

            {/* Cinematic vignette — deepens the edges for a mysterious mood */}
            <div
                aria-hidden
                className="pointer-events-none fixed inset-0 z-30 bg-[radial-gradient(125%_125%_at_50%_28%,transparent_45%,hsl(var(--background)/0.55))]"
            />
            ...
            <div className="relative z-10">
                <header className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur">
                    <div className="container flex h-16 items-center justify-between">
                        <button
                            ...
                            className="flex cursor-pointer items-center gap-2 font-bold tracking-tight"
                ...
                <main>
                    <section className="container grid items-center gap-12 py-24 md:grid-cols-2 md:py-36">
                        <Reveal>
                            <Badge variant="outline" className="mb-6 font-mono">
                                Full Stack · 8 years
                            </Badge>
                            <h1 className="animate-shimmer bg-gradient-to-r from-foreground via-foreground/40 to-foreground bg-[length:250%_100%] bg-clip-text text-6xl font-black leading-[0.95] tracking-tighter text-transparent motion-reduce:animate-none sm:text-7xl lg:text-8xl">
                                Roel R. Longcop
                            </h1>
                            <p className="mt-6 max-w-lg text-lg text-muted-foreground sm:text-xl">
                                ...
                                craft — yin and yang — into reliable, intuitive
                                web applications.
                            </p>
                        ...
                        <Reveal delay={120} className="flex justify-center">
                            <div className="relative">
                                <div className="absolute inset-0 -z-10 animate-glow-pulse rounded-full bg-foreground/10 blur-3xl motion-reduce:animate-none" />
                                <YinYang className="h-64 w-64 animate-[spin_28s_linear_infinite] drop-shadow-xl motion-reduce:animate-none sm:h-80 sm:w-80 lg:h-96 lg:w-96" />
                    ...
                    <section
                        id="about"
                        className="scroll-mt-16 border-t border-border/60 py-24 sm:py-32"
                    >
                        <div className="container">
                            <Reveal>
                                ...
                                <p className="max-w-3xl text-lg leading-relaxed text-muted-foreground">
                                    Innovative Full Stack Software Developer
                                    with{' '}
                                    <span className="font-semibold text-foreground">
                                        8 years of experience
                                    </span>{' '}
                                    building comprehensive and reliable web
                                    applications. Skilled across the stack —
                                    pairing robust back-end engineering with
                                    intuitive, responsive front-ends. Dedicated
                                    to continuous learning, effective
                                    problem-solving, and delivering high-quality
                                    applications that enhance the user
                                    experience.
                                </p>
                            </Reveal>
                        </div>
                    ...
                    <section className="scroll-mt-16 border-t border-border/60 py-24 sm:py-32">
                        <div className="container">
                            <Reveal>
                                <SectionHeading
                                    kicker="Experience"
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                {PROJECTS.map((p, i) => (
                                    <Reveal key={p.name} delay={i * 80}>
                                        ...
                                        >
                                            <Card className="h-full transition-all duration-300 [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-1 hover:border-foreground/30 hover:shadow-lg">
                                                ...
                                                <div className="mt-4 flex gap-3 overflow-x-auto pb-1">
                                                    {app.shots.map((src, i) => (
                                                        <button
                                                            ...
                                                            className="shrink-0 cursor-pointer overflow-hidden rounded-2xl border border-border transition-transform hover:-translate-y-1"
                                ...
                                <Card className="overflow-hidden">
                                    <CardContent className="flex flex-col items-center gap-6 px-6 py-12 text-center sm:px-12">
                                        ...
                                        <p className="max-w-xl text-muted-foreground">
                                            ...
                                            Laravel + React admin platform I
                                            built — roles, exports, imports,
                                            backups, observability and more.
                                            Create an account to take a
                                            read-only tour of the live backend.
                                        </p>
                ...
                <footer className="border-t border-border/60 py-10">
                    <div className="container flex flex-col items-center justify-between gap-4 sm:flex-row">
                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            <YinYang className="h-5 w-5" />
                            <span>
                                © {new Date().getFullYear()} Roel R. Longcop ·
