...
return [
    ...
    */
    ...
    'disks' => [
        ...
        | storage/app/private/* (outside the web root); the s3 keys point at
        | SeaweedFS. Irrelevant keys are ignored by the active driver, so a
        | single definition serves both modes. Downloads always go through
        | gated controller actions — never a public URL.
        */
